...
export default function WishlistPage() {
  ...
  // "Ù†Ù‚Ù„ Ù„Ù„Ø³Ù„Ø©": Ù†Ø¶ÙŠÙ Ø§Ù„Ù…Ù†ØªØ¬ Ù„Ù„Ø³Ù„Ø© Ø«Ù… Ù†Ø²ÙŠÙ„Ù‡ Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø£Ù…Ù†ÙŠØ§Øª
    ...
    return (
      <main className="max-w-md mx-auto px-4 py-16 text-center">
        <p className="text-gray-500 mb-4">
          {lang === "ar" ? "ÙŠØ¬Ø¨ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ Ù„Ø¹Ø±Ø¶ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø£Ù…Ù†ÙŠØ§Øª" : "Please login to view your wishlist"}
        </p>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <p className="text-gray-400 mb-4">
            {lang === "ar" ? "Ù‚Ø§Ø¦Ù…Ø© Ø£Ù…Ù†ÙŠØ§ØªÙƒ ÙØ§Ø±ØºØ©" : "Your wishlist is empty"}
          </p>
