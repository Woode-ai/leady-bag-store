...
export default function CartPage() {
    ...
    return (
      <main className="max-w-2xl mx-auto px-4 py-16 text-center">
        <p className="text-gray-500 mb-4">
          {lang === "ar" ? "ÙŠØ¬Ø¨ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ Ù„Ø¹Ø±Ø¶ Ø§Ù„Ø³Ù„Ø©" : "Please login to view your cart"}
        </p>
  ...
  // Ø­Ø³Ø§Ø¨ Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹ Ø§Ù„ÙØ±Ø¹ÙŠ Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ù„Ø³Ø¹Ø± Ø§Ù„Ø­Ø§Ù„ÙŠ Ù„ÙƒÙ„ Ù…Ù†ØªØ¬
  ...
  // Ø­Ø³Ø§Ø¨ Ù‚ÙŠÙ…Ø© Ø§Ù„Ø®ØµÙ… Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ù„ÙƒÙˆØ¨ÙˆÙ†
      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm h-fit space-y-6">
            <h2 className="font-bold text-secondary text-lg border-b pb-3">{lang === "ar" ? "Ù…Ù„Ø®Øµ Ø§Ù„Ø·Ù„Ø¨" : "Order Summary"}</h2>
              ...
              {cart?.couponCode && couponData ? (
                <div className="flex items-center justify-between bg-green-50 border border-green-200 text-green-700 px-3 py-2 rounded-xl text-sm font-medium">
                  ...
                  <button
                    ...
                    title={lang === "ar" ? "Ø¥Ù„ØºØ§Ø¡ Ø§Ù„ÙƒÙˆØ¨ÙˆÙ†" : "Remove coupon"}
                  >
                    <X size={16} />
                  </button>
                </div>
                ...
                <form onSubmit={applyCoupon} className="flex gap-2">
                  <input
                    type="text"
                    placeholder={lang === "ar" ? "Ø§Ø¯Ø®Ù„ÙŠ Ø§Ù„ÙƒÙˆØ¯..." : "Enter code..."}
                    value={couponInput}
            ...
            {/* ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ø£Ø³Ø¹Ø§Ø± ÙˆØ§Ù„Ø­Ø³Ø§Ø¨ */}
