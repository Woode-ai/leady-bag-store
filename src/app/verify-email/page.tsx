...
function VerifyEmailContent() {
  ...
  async function handleResend() {
    if (!email) {
      setMessage("يرجى كتابة بريدك الإلكتروني");
      return;
    }
    setResending(true);
    setResendMsg("");
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
        {status === "success" ? (
          <div className="text-center py-6">
            ...
            <h1 className="text-2xl font-bold text-secondary mb-2">تم تفعيل حسابك بنجاح!</h1>
            <p className="text-gray-500 text-sm mb-6">{message || "سيتم تحويلك إلى المتجر تلقائياً..."}</p>
            <Link
              href="/"
          ...
          <div>
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-bold text-secondary">تأكيد البريد الإلكتروني</h1>
              <p className="text-sm text-gray-500 mt-1">
                أدخلي رمز التحقق (OTP) المكون من 6 أرقام المُرسل إلى بريدك
              </p>
            </div>
            ...
            <form onSubmit={handleVerifyCode} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-600 mb-1">رمز التحقق (6 أرقام)</label>
                <input
                  type="text"
                  maxLength={6}
                  required
              ...
              >
                {status === "loading" ? (
                  ...
                  <>
                    تأكيد وتفعيل الحساب <ArrowRight size={18} />
                  </>
                )}
              </button>
            </form>
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 text-center">
              ...
              >
                {resending ? "جاري الإرسال..." : "لم يصلك الرمز؟ إعادة إرسال رمز جديد"}
              </button>
