...
const links = [
  ...
  { href: "/admin/looks", label: "تنسيق الإطلالات (Looks)", icon: Sparkles },
  { href: "/admin/orders", label: "الطلبات والمدفوعات", icon: ShoppingCart },
  ...
  { href: "/admin/settings", label: "الإعدادات والمكافآت", icon: Settings },
];
